...
@section('content')
    ...
    <form id="fileupload" action="{{ route('picture.dostore',$regid) }}" method="post" enctype="multipart/form-data">
        <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->

        <div class="row fileupload-buttonbar">
            <div class="col-lg-7" id="blueimpdiv">
...
@section('scripts')
    @include('admin.picture.blueim_x-template')
