                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="caption font-red-sunglo">
                                    ...
                                    <span class="caption-subject bold uppercase"> List of Students </span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <a class="btn sbold green" id="sample_editable_1_new" href="{{ route('student.create') }}" >Add New <i class="fa fa-plus"></i></a>
                        ...
                        @foreach($students as $student)
                            <tr class="odd gradeX">
                                ...
                                @if($student->image==0)
                                    ...
                                    <td>Available</td>
                                @endif
                                <td> <a href="{{ route('user.show', $student->user->id) }}" class="btn btn-xs btn-success">Details</a> </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="{!! route('user.edit', $student->user->id) !!}">
                                                    <i class="icon-docs"></i> Edit </a>
                                            </li>
                                            <li>
                                                <a class="deleteBtn" href="#" data-toggle="modal" data-target="#deleteConfirm" deleteUrl="{{ route('user.delete', $student->user->id) }}">
