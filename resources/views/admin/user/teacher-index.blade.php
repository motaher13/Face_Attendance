                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <a class="btn sbold green" id="sample_editable_1_new" href="{{ route('teacher.create') }}" >Add New <i class="fa fa-plus"></i></a>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="dataTable">
                        ...
                        @foreach($teachers as $teacher)
                            <tr class="odd gradeX">
                                ...
                                <td> <a href="{{ route('user.show', $teacher->user->id) }}" class="btn btn-xs btn-success">Details</a> </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a class="deleteBtn" href="#" data-toggle="modal" data-target="#deleteConfirm" deleteUrl="{{ route('user.delete', $teacher->user->id) }}">
