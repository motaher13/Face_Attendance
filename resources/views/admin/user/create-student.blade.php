            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> Create a Student</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                ...
                <div class="portlet-body form">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('student.store') }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="session" class="form-control" name="session" id="session" required>
                            </div>
                        </div>


                        <div class="form-group">
                            <label for="regid" class="col-md-2 control-label">Reg no</label>
                            <div class="col-md-4">
                                <input type="regid" class="form-control" name="regid" id="regid" required>
                            </div>
                        </div>
