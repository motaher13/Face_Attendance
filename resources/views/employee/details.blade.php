                ...
                <div class="portlet light bordered">
                    <div class="portlet-heading">
                        <h4 class="portlet-title">
                            <a data-toggle="collapse" href="#collapse1">Educational Details</a>
                        </h4>
                    </div>
                    <div id="collapse1" class="portlet-collapse collapse">
                        <div class="portlet-body">
                            <div class="row">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    <div class="tab">
                        ...
                        <button class="tablinks" onclick="openCity(event, 'Future')">Scheduled Courses</button>
                    </div>
