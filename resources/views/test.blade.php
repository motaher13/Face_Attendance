...
<head>
    ...
    <link rel="stylesheet" href="{!! asset('assets/global/plugins/dropzone/basic.min.css') !!}">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="{{ url('/create') }}">Upload</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/create') }}">Upload Images</a>
            </li>
            <li class="nav-item">
